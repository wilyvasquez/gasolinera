      ...
      <form role="form" id="agregarCliente">
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="nombre" placeholder="Cantidad">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="nombre" placeholder="Factura">
          </div>
          <div class="form-group">
            <label for="nombre">Descripcion: </label>
            <textarea class="form-control" rows="3" placeholder="Descripcion..."></textarea>
          </div>
          <div class="form-group" id="msg_cantidad"></div>
        </div>
